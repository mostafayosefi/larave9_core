  @component('admin.layouts.content', [
      'title' => 'ویرایش استاد',
      'tabTitle' => ' ویرایش استاد',
      'breadcrumb' => [['title' => 'لیست صفحات سایت', 'url' => route('admin.course.teacher.index')], ['title' => 'ویرایش استاد  ',
      'class' => 'active']],
      ])
                  ...
                  <div class="col-md-12 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form class="forms-sample" method="POST" action="{{ route('admin.course.teacher.update', $teacher) }}"
                                      ...
                                      <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" autocomplete="off"
                                                placeholder=" نام و نام خانوادگی  " name="name" value="{{$teacher->name}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="education" autocomplete="off"
                                                placeholder=" مدرک تحصیلی " name="education" value="{{$teacher->education}}">
                                        </div>
   ...
   @include('admin.layouts.table.avatarnul', [  'avatarimage' => $teacher->image , 'class'=>'profile-pic' , 'style' => 'height: 400px;width: 400px;'  ])
