...
return [
    ...
    */
    ...
    'captcha' => 'لطفا فیلد  :attribute  را به صورت صحیح وارد نمایید.',
    ...
    */
    ...
    'attributes' => [
        ...
        "image" => "تصویر",
        "images" => "تصاویر",
        "advertisement" => "پیام تبلیغاتی",
        "businessName" => "نام کسب و کار",
        "jobs" => "نام کسب و کار",
        "city_id" => "شهر",
        "postalAddress" => "آدرس پستی",
        "service_product" => "خدمات و محصولات",
        "website" => "وبسایت",
        "postalCode" => "کد پستی",
        "verification_code" => "کد اعتبار سنجی",
        "nameFamily" => "نام و نام خانوادگی",
        "reasonActivities" => "دلایل فعالیت",
        "amountOfSalaryRequested" => "میزان حقوق درخواستی",
        "jobCategory" => "بخش فعالیت",
        "dorm" => "نیاز به خوابگاه",
        "methodIntroduction" => "طریقه آشنایی با جیک جاب",
        "acceptanceOfRules" => "پذیرش قوانین",
        "workTime" => "شیفت کاری",
        "speed" => "سرعت محل",
        "Interaction in teamwork" => "تعامل در کار گروهی",
